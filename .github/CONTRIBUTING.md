...
Please note we have a [code of conduct](https://github.com/FantasticFiasco/.github/blob/master/CODE_OF_CONDUCT.md), please follow it in all your interactions with the project.
...
```
git clone https://github.com/FantasticFiasco/axis-js.git
cd axis-js
yarn
