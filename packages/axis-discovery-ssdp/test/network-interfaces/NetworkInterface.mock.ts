...
export const NETWORK_INTERFACE_WITH_TWO_ADDRESSES: Record<string, NetworkInterfaceInfoIPv4[]> = {
    Ethernet: [
...
export const NETWORK_INTERFACES_WITH_TWO_ADDRESSES: Record<string, NetworkInterfaceInfoIPv4[]> = {
...
export const NETWORK_INTERFACES_WITH_INTERNAL_ADDRESSES: Record<string, NetworkInterfaceInfoIPv4[]> = {
...
export const NETWORK_INTERFACES_WITH_IPV6_ADDRESSES: Record<string, NetworkInterfaceInfoIPv6[]> = {
    Ethernet1: [
        {
