...
describe('get parameters request', () => {
    ...
    test('should return URL when getting all parameters', () => {
        ...
        // Assert
        expect(got.url).toBe('http://1.2.3.4:1234/axis-cgi/param.cgi?action=list&responseformat=rfc');
    });
    ...
    test('should return URL when getting single parameter', () => {
        ...
        // Assert
        expect(got.url).toBe('http://1.2.3.4:1234/axis-cgi/param.cgi?action=list&group=Network.UPnP.FriendlyName&responseformat=rfc');
    });
    ...
    test('should return URL when getting multiple parameters', () => {
        ...
        // Assert
        expect(got.url).toBe(
            'http://1.2.3.4:1234/axis-cgi/param.cgi?action=list&group=Network.UPnP.FriendlyName,Properties.API.HTTP.Version&responseformat=rfc',
        );
    });
    ...
    test('should return URL when getting single group', () => {
        ...
        // Assert
        expect(got.url).toBe('http://1.2.3.4:1234/axis-cgi/param.cgi?action=list&group=Network&responseformat=rfc');
    });
    ...
    test('should return URL when getting multiple groups', () => {
        ...
        // Assert
        expect(got.url).toBe('http://1.2.3.4:1234/axis-cgi/param.cgi?action=list&group=Network,Properties&responseformat=rfc');
    });
    ...
    test('should return URL when getting single group with wildcard', () => {
        ...
        // Assert
        expect(got.url).toBe('http://1.2.3.4:1234/axis-cgi/param.cgi?action=list&group=Network.*.FriendlyName&responseformat=rfc');
    });
    ...
    test('should return URL when getting multiple groups with wildcards', () => {
        ...
        // Assert
        expect(got.url).toBe('http://1.2.3.4:1234/axis-cgi/param.cgi?action=list&group=Network.*.FriendlyName,Properties.API.*.Version&responseformat=rfc');
    });
});
